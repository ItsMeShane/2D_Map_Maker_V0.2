...
public class TileList {
    ...
    public static Tile[] tileID = new Tile[3920];   // #tiles+2 (empty)
    ...
    public TileList() {
        try {
            ...
            for (int ID = 1; ID < tileID.length/2; ID++) tileID[ID].image = ImageIO.read(Objects.requireNonNull(ClassLoader.getSystemResourceAsStream("Tile ID = (" + ID + ").png")));
